...
var check_srs_engagement = func (){
    ...
    # returns 0 if not engaged
    # returns 1 if engaged in SRS TO 
    # returns 2 if engaged in SRS GA
    ...
    if (((eng1_state == "TOGA" or eng2_state == "TOGA") 
        ...
        # if SRS TO is engaged (conditions met)
        # (see FCOM 12.22_30-40 AP/FD Modes/SRS GA Mode)
        ITAF.setVertMode(7);
        ...
        if (engout) {
           upper_srs_limit = getprop("/FMGC/internal/vls") + 15;
        } else {
           upper_srs_limit = getprop("/FMGC/internal/vls") + 25;
        }
        ...
        print("MIN: ", FMGCInternal.vapp);
        print("MAX: ", upper_srs_limit);
        ...
        if (getprop("/FMGC/internal/above-ga-accel-alt") == 1) {
            ...
            # mode reversion as SRS is engaged
