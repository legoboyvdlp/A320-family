...
var updateFuel = func {
	...
	if (FMGCInternal.toFromSet and FMGCInternal.crzSet and FMGCInternal.crzTempSet and FMGCInternal.zfwSet) {
		...
		todw = FMGCInternal.tow; # for testing purposes
		...
		# update climb values
		# FMGCInternal.clbFuel;
		# FMGCInternal.clbDist = FMGCInternal.clbDist * math.max(1.0 - (math.max(pts.Position.gearAglFt.getValue() - 1500.0, 0.0) / crz), 0.0);
