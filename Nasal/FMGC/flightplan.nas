...
var flightPlanController = {
	...
	# args: ghostContainer, index, flag, plan, flagPBD, flagPROG
	...
	calculateDecelPoint: func(n) {
		...
		for (var wpt = 0; wpt < me.flightplans[n].getPlanSize(); wpt += 1) {
			...
			if (wpt == me.flightplans[n].getPlanSize()) {
				me.indexDecel = me.arrivalIndex[n] - 2;
				break;
			}
		}
	...
	flightPlanChanged: func(n, callCalculate = 1) {
		me.updatePlans(1, callCalculate);
	...
	updatePlans: func(runCalculate = 0, callCalculate = 1) {
