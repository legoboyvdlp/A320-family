...
var prova_timer = aircraft.timer.new("/instrumentation/prova/elapsetime-sec",1,0);
...
var clock_timer = aircraft.timer.new("/instrumentation/clock_et/elapsetime-sec",1,0);
var clock_int_et = aircraft.timer.new("/instrumentation/clock-internal/elapsetime-sec",1,0);
var chrono_timer = aircraft.timer.new("/instrumentation/chrono[0]/elapsetime-sec",1,0);

var chr_min = nil;
var chr_sec = nil;
var chr_tmp = nil;
#var clock_hh = nil;
#var clock_punctuation = nil;
#var clock_mm = nil;
#var clock_sec = nil;
#var day = nil;
var et_hr = nil;
...
var clock_et = {
	sec: props.globals.initNode("/instrumentation/clock_et/indicated-sec", 0, "INT"),
	hrs: props.globals.initNode("/instrumentation/clock_et/indicated-hours", 0, "INT"),
	min: props.globals.initNode("/instrumentation/clock_et/indicated-min", 0, "INT"),
	elapsedString: props.globals.initNode("/instrumentation/clock_et/elapsed-string", "", "STRING"),
	et: props.globals.getNode("/instrumentation/clock_et/elapsetime-sec"),
	...
	#et_selector:  props.globals.initNode("/instrumentation/clock/et-selector", 1, "INT"),
...
var clock = {
	#sec: props.globals.initNode("/instrumentation/clock/indicated-sec", 0, "INT"),
	#hrs: props.globals.initNode("/instrumentation/clock/indicated-hour", 0, "INT"),
	#min: props.globals.initNode("/instrumentation/clock/indicated-min", 0, "INT"),
	#elapsedString: props.globals.initNode("/instrumentation/clock/elapsed-string", "", "STRING"),
	#et: props.globals.getNode("/instrumentation/clock/elapsetime-sec"),
	hhMM: props.globals.initNode("/instrumentation/clock/indicated-short-string", "", "STRING"),
...
var chrono = {
	reset: props.globals.initNode("/instrumentation/chrono[0]/chrono-reset", 1, "INT"),
	reset_btn: props.globals.initNode("/instrumentation/chrono[0]/chrono-reset-btn", 0, "INT"),
	btn: props.globals.initNode("/instrumentation/chrono[0]/chrono-btn", 0, "INT"),
	et: props.globals.initNode("/instrumentation/chrono[0]/elapsetime-sec", 0, "INT"),
	...
	etString: props.globals.initNode("/instrumentation/chrono[0]/chr-et-string", "", "STRING"),
	paused: props.globals.initNode("/instrumentation/chrono[0]/paused", 0, "INT"),
	started: props.globals.initNode("/instrumentation/chrono[0]/started", 0,"INT"),
};

#Cpt chrono
var cpttimer = {
	et: props.globals.initNode("/instrumentation/ndchrono[0]/elapsetime-sec", 0, "INT"),
	#started: props.globals.getNode("/instrumentation/ndchrono[0]/started"),
	#paused: props.globals.getNode("/instrumentation/ndchrono[0]/paused"),
	#started_at: props.globals.getNode("/instrumentation/ndchrono[0]/started-at"),
...
var fotimer = {
	...
	#started: props.globals.getNode("/instrumentation/ndchrono[1]/started"),
	#paused: props.globals.getNode("/instrumentation/ndchrono[1]/paused"),
	#started_at: props.globals.getNode("/instrumentation/ndchrono[1]/started-at"),
...
#Chrono
setlistener("/instrumentation/chrono[0]/chrono-btn", func {
...
setlistener("/instrumentation/chrono[0]/chrono-reset-btn", func {
...
#ET Clock
setlistener("/instrumentation/clock/et-selector", func {
	tmp1 = clock.et_selector.getValue();
	if (tmp1 == 2){
		clock_timer.reset();
	} elsif (tmp1 == 1){
		clock_timer.stop();
...
#		#Clock Internal
		...
		clock_et.hrs.setValue(et_hr);
		clock_et.min.setValue(et_min);
		if (clock.et_selector.getValue()==1) {
